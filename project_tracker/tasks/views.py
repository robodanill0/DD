...
class IndexView(View):
    def get(self, request, *args, **kwargs):
        ...
        html = f"<h1>Страница приложения tasks</h1><h2><a href='{projects_list_url}'></h2><h2>Список проектов</a></h2><h2><a href='/quality_control/'>Перейти на quality_control</a></h2>"
